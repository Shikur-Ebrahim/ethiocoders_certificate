...
export async function verifyApplication(id: string) {
  try {
    ...
    const nameOverlay = `co_rgb:0000a0,l_text:Arial_50_bold:${name}/fl_layer_apply,g_west,x_100,y_130`;
    const dateOverlay = `co_rgb:444444,l_text:Arial_30:${encodedDate}/fl_layer_apply,g_west,x_100,y_170`;
